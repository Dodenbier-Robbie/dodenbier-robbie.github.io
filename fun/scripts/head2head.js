...
function getHead2Head(season,teamId1,teamId2) {
	var url = "";

	if (teamId1 > 0 && season != 0) {
		url = apiURL + "/games?league=12&season=" + season + "&h2h=" + teamId1 + "-" + teamId2;
...
function loadPage(){
	...
	var teamId1 = document.getElementById("teamName1").value;
	var teamId2 = document.getElementById("teamName2").value;
	getHead2Head(season,teamId1,teamId2);
}
